...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		// __________________________________________________ DISPLAY PAGE 2  ?>
			<?php if (($_POST['jobList']=="Sales Agent" and $_POST['pword'] == "furnish") or ($_POST['jobList']=="Management" and $_POST['pword'] == "manager"))
			{ ?>
			...
			{ ?>
				...
				<form method="POST" action="login.php">
					...
					<input type="hidden" name="job" value="<?phpprint $_POST['jobList'];?>"/>
		...
		// __________________________________________________ DISPLAY PAGE 3  ?>
			...
			<?php if (($_POST['pword'] == "furnish" and $_POST['job'] == "Sales Agent") or ($_POST['pword'] == "manager" and $_POST['job'] == "Management"))
			{ ?>
		<center><h2>You entered the correct password!  But it took you two tries. </h2>
			...
			<form method="POST" action="password.php">
				<input type="hidden" name="job" value="<?phpprint $_POST['job'];?>"/>
				Password: <input type = "password" name="pword" /><br /><br />

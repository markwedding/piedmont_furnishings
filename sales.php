...
<body>
	...
	<?php if(isset($_POST['submitdates'])){
		...
		<p>XML file:<a href="<?php echo $address?>"><?php echo $address?></a></p>
		<p>Document Type Definition file:<a href="<?php echo $dtdaddress?>"><?php echo $dtdaddress?></a></p>
	...
	<?php
		...
		<form id="daterange" method="post" action="sales.php">
			<?php/*<table>
				<tr>
					<td>Start Date:</td>
					<td><input type="text" name="startdate" value="<?php
				...
				<tr>
					<td>End Date:</td>
					<td><input type="text" name="enddate" value="<?php echo date('Y-m-d');?>"/></td>
				</tr>
			</table>*/?>
				...
				<tr>
					...
					<td><select name="smonth">
						<?php for($i = 0; $i < count($months); ++$i){?>
							<option><?php echo $months[$i]?></option> <?php echo "\n";
						}?>
						</select>
					</td>
					...
					<td><select name="syear">
						<?php for($i = (date('Y')-10); $i <= date('Y'); ++$i){?>
							<option><?php echo $i?></option> <?php echo "\n";
						}?>
					</td>
				</tr>
				<tr>
